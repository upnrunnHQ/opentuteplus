...
<?php do_action('opentute_comments_before'); ?>

<div id="comments" class="comments-area">

	<?php do_action('opentute_comments_top'); ?>
...
<?php endif; // end have_comments() ?>
	...
	<?php do_action('opentute_comments_bottom'); ?>
	
</div><!-- .comments-area -->

<?php do_action('opentute_comments_after'); ?>